...
-- CreateIndex
CREATE INDEX "emp_org_idx" ON "Employee"("organizationId");

-- CreateIndex
CREATE INDEX "emp_user_idx" ON "Employee"("userId");
...
-- Seed a single default organization for copied pre-SaaS data.
...
-- Backfill existing employees into the default organization.
UPDATE "Employee"
